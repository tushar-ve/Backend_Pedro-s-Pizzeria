...
urlpatterns = [
    ...
    path('menuitems/<int:item_id>/', MenuDescriptionView.as_view()),
    path('add-cart/', CartItemListCreateAPIView.as_view()),
    path('cart-items/<int:cart_item_id>/', CartItemDeleteAPIView.as_view()),
    path('cart/user/<str:user_id>', CartDetailView.as_view()),
